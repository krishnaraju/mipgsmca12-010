...
<table align="center" width="578" style="border:1px solid #d2d2d2;" bgcolor="#FFFFFF">
	...
	Statement st1=null;
	ResultSet rs1=null;
	String sql1="select MD5(query),AES_DECRYPT(id,'key'),publish,author,cost,cdate,ctime from text where query='"+query+"'";
	try
	{
		...
		while(rs1.next())
	     {
			...
			%>
          <tr> 
		   <td width="185" align="left" class="paragraping1">Book Name</td>
		   <td width="63">:</td>
            <td width="314" height="46" class="paragraping1"><% out.println(rs1.getString(1));%></td>
			</tr>
			<tr>
			 <td width="185"  align="left" class="paragraping1">ID</td>
			  <td>:</td>
			 <td height="46" class="paragraping1"><% out.println(rs1.getString(2));%></td>
			</tr>
			<tr>
			 <td width="185" height="43"  align="left" class="paragraping1">Publish</td>
			  <td>:</td>
            <td class="paragraping1"><font color="#FF0000"><% out.println(rs1.getString(3));%></font></td>
			  </tr>
			  <tr>
			  <td width="185" height="46" align="left" class="paragraping1">Author</td>
			   <td>:</td>
            <td class="paragraping1"><font color="#FF0000"><% out.println(rs1.getString(4));%></font></td>
			  </tr>
			  <tr>
			   <td width="185" height="44" align="left" class="paragraping1">Cost</td>
			    <td>:</td>
            <td class="paragraping1"><font color="#FF0000"><% out.println(rs1.getString(5));%> </font></td>
			  </tr>
			  <tr>
			   <td width="185" height="43" align="left" class="paragraping1">Date</td>
			    <td>:</td>
            <td class="paragraping1"><font color="#FF0000">
              <% out.println(rs1.getString(6));%>
              </font></td>
			  </tr>
			  <tr>
			   <td width="185" height="38" align="left" class="paragraping1">Time</td>
			    <td>:</td>
            <td class="paragraping1"><font color="#FF0000">
...
<tr> 
		   <td width="131" align="left" class="paragraping1">Book Name</td>
		   <td width="14">:</td>
...
%> 
		   ...
		   <td width="14">:</td>
            <td width="250" height="46" class="paragraping1"><font color="#FF0000"><%=hitsCount%>.766&nbsp;&nbsp;KB/s</font></td>
			</tr>
</table>
</td></tr>
  <%
