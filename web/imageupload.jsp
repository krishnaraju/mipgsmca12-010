...
<tr>
<td width="660" height="477" valign="top" bgcolor="#FFFFFF"><br><br>
<table align="center" width="454" bgcolor="#FFFFFF" style="border:1px solid #d2d2d2">
<FORM ENCTYPE="multipart/form-data" name="form3" ACTION="upload.jsp" METHOD="POST" onsubmit="return validation();">
<tr>
<td  colspan="2" class="paragraping" background="images/pattern_bg.gif" align="center">Upload Image Here</td>
</tr>
<tr>
<td width="237" height="53" class="paragraping1">Image Name:</td>
